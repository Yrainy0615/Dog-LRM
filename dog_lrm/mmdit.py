...
class TransformerDecoder(nn.Module):
    ...
    def _block_fn(self, inner_dim, cond_dim, mod_dim):
        ...
        if self.block_type == "basic":
            ...
            from .transformer_dit import CogVideoXBlock
            ...
            from .transformer_dit import SD3JointTransformerBlock
            ...
            from .transformer_dit import SD3MMJointTransformerBlock
            ...
            logger.debug(f"Using SD3MMJointTransformerBlock")
            from .transformer_dit import SD3BodyHeadMMJointTransformerBlock
